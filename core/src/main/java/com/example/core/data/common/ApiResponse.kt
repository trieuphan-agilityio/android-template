 ...
 */
private fun <T> handleError(response: Response<T>): ApiErrorResponse<T> {
    ...
    val gson = Gson()
    return try {
        gson.fromJson<ApiErrorResponse<T>>(errorBody, ApiErrorResponse::class.java)
...
data class ApiErrorResponse<T>(
    ...
    val errorMessage: String) : ApiResponse<T>()